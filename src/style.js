const styles = {
    ...
    formInput: "font-poppins font-normal text-[16px] leading-[24px] text-black bg-white border border-[#d1d5db] rounded-[10px] px-4 py-3 mt-2 w-full outline-hidden focus:border-customRed",
